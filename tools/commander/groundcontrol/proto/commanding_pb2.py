...
_COMMANDQUEUEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='url', full_name='commanding.CommandQueueInfo.url', index=8,
...
_COMMANDQUEUEENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uuid', full_name='commanding.CommandQueueEntry.uuid', index=8,
      number=9, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_COMMANDSIGNIFICANCE.fields_by_name['significance'].message_type = mdb_pb2._SIGNIFICANCEINFO
_COMMANDHISTORYATTRIBUTE.fields_by_name['value'].message_type = yamcs_pb2._VALUE
